...
class videoplayer extends Component {
    ...
    render() {
        return (
            <div className={classes.VideoPLaySection}>
                <iframe className={classes.videoLink} src={`https://player.vimeo.com/video/${this.state.data.vimeoId}`} frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen></iframe>
